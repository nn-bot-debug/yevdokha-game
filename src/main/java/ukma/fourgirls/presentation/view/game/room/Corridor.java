...
import ukma.fourgirls.presentation.view.game.puzzle.FirstPuzzle;
...
public class Corridor extends Place {
    ...
    private void startPuzzleSequence() {
        ...
        FirstPuzzle gradientPuzzle = new FirstPuzzle(context, () -> {
            this.root.getChildren().removeIf(node -> node instanceof FirstPuzzle);
            wentOut();
        });
    ...
    private void startIntroCutscene() {
        ...
        StoryService.playScene(context, "/story/chapter1.json", "corridor_intro", (StackPane) this.getRoot(), actions, null);
    }
