...
import ukma.fourgirls.presentation.view.game.puzzle.SeventhPuzzle;
import ukma.fourgirls.presentation.view.game.puzzle.SixthPuzzle;
    ...
    private static final String LAKE_LUKYAN = "/images/canvas/with_lukyan.png";
        ...
        public void onEnter() {
            ...
            actions.put("dinner-scene", () ->{
                ...
                StoryService.playScene(context, "/story/chapter3.json", "mavka-dinner-scene", (StackPane) this.getRoot(), actions, null);
            });
            ...
            actions.put("enable-lake-eye-button", () -> {
                ...
                eyeButton.setOnAction(event -> {
                    ...
                    StoryService.playScene(context, "/story/chapter3.json", "mavky-meeting-scene", (StackPane) this.getRoot(), actions, null);
                });
            ...
            actions.put("trigger_bad_end_part2", () -> {
                StoryService.playScene(context, "/story/theend.json", "bad-end-part2-water", (StackPane) this.getRoot(), actions, null);
            });
                ...
                SeventhPuzzle scalePuzzle = new SeventhPuzzle(context, (karmaReward) -> {
                    ...
                    if (finalKarma < 7) {
                        ...
                        if (putDrawingOnScale) {
                            StoryService.playScene(context, "/story/theend.json", "bad-end-part1-with-drawing", (StackPane) this.getRoot(), actions, null);
                        } else {
                            StoryService.playScene(context, "/story/theend.json", "bad-end-part2-water", (StackPane) this.getRoot(), actions, null);
                        }
                    } else {
                        StoryService.playScene(context, "/story/theend.json", "good-ending", (StackPane) this.getRoot(), actions, null);
                    }
                });
            ...
            StoryService.playScene(context, "/story/chapter3.json", "lake-meeting-scene", (StackPane) this.getRoot(), actions, null);
            playFadeIn();
        }
