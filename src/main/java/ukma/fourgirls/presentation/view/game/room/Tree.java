...
import ukma.fourgirls.presentation.view.game.puzzle.FourthPuzzle;
import ukma.fourgirls.presentation.view.game.puzzle.ThirdPuzzle;
...
public class Tree extends Place {
    ...
    private void startTreeCutscene() {
        ...
        actions.put("enable_tree_eye_button", () -> {
            ...
            eyeButton.setOnAction(e -> {
                ...
                StoryService.playScene(context, "/story/chapter2.json", "ant_colony_dialogue", (StackPane) this.getRoot(), actions, null);
            });
        ...
        actions.put("trigger_root_vision", () -> {
            StoryService.playScene(context, "/story/chapter2.json", "ant_rescue_start", (StackPane) this.getRoot(), actions, null);
        });
        ...
        actions.put("enable_resin_planning", () -> {
            FourthPuzzle logicPuzzle = new FourthPuzzle(context, (puzzleResult) -> {
                ...
                StoryService.playScene(context, "/story/chapter2.json", "resin_collection_success", (StackPane) this.getRoot(), actions, null);
            });
        ...
        StoryService.playScene(context, "/story/chapter2.json", "resin_tree_intro", (StackPane) this.getRoot(), actions, null);
    }
    ...
    private void onPuzzleFinished(int livesLeft, Map<String, Runnable> actions) {
        ...
        StoryService.playScene(context, "/story/chapter2.json", "ant_rescue_success", (StackPane) this.getRoot(), actions, null);
    }
}