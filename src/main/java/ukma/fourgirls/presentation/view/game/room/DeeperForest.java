...
import ukma.fourgirls.presentation.view.game.puzzle.FifthPuzzle;
    ...
    public void onEnter() {
        ...
        actions.put("enable-blud-eye-button", () -> {
            ...
            eyeButton.setOnAction(event -> {
                ...
                StoryService.playScene(context, "/story/chapter3.json", "blud-intro-scene", (StackPane) this.getRoot(), actions, null);
            });
        ...
        actions.put("choice_refuse_game", () -> {
            ...
            StoryService.playScene(context, "/story/chapter3.json", "blud-rejection-scene", (StackPane) this.getRoot(), actions, null);
        });

        actions.put("choice_accept_game", () -> {
            session.changeKarma(1);
            StoryService.playScene(context, "/story/chapter3.json", "blud-agreement-scene", (StackPane) this.getRoot(), actions, null);
        });
        ...
        StoryService.playScene(context, "/story/chapter3.json", "blud-meeting-scene", (StackPane) this.getRoot(), actions, null);
        playFadeIn();
    }
