package ukma.fourgirls.domain.model; // Змінено папку!
...
public class GameSession {
    ...
    public interface InventoryChangeListener {
        void onInventoryChanged(List<Item> currentItems);
    }
    ...
    public void removeItem(String itemName) {
        boolean removed = inventoryItems.removeIf(item -> item.getName().equals(itemName));
        if (removed) {
            notifyInventoryChanged();
        }
    }
    ...
    private void notifyInventoryChanged() {
        if (inventoryListener != null) {
            inventoryListener.onInventoryChanged(getInventoryItems());
        }
    }
    ...
    public void setInventoryListener(InventoryChangeListener inventoryListener) {
