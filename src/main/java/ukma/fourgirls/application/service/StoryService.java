...
import ukma.fourgirls.presentation.animation.CutsceneBuilder;
import ukma.fourgirls.presentation.component.ChoiceManager;
...
public class StoryService {
    ...
    public static void playScene(GameContext context, String jsonFilePath, String sceneId, StackPane roomRoot, Map<String, Runnable> actions, Map<String, Animation> animations) {
        ...
        InputStream inputStream = StoryService.class.getResourceAsStream(jsonFilePath);
        if (inputStream == null) {
        ...
        CutsceneBuilder sequence = CutsceneBuilder.create(roomRoot, context);
                ...
                case "dialogue":
                    if (event.character != null && !event.character.isEmpty()) {
                        ...
                        if (event.portrait != null && !event.portrait.isEmpty()) {
                            portrait = new Image(Objects.requireNonNull(StoryService.class.getResourceAsStream(event.portrait)));
                        }
